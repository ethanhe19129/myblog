...
Revision ID: 4e1f757805ef
Revises: 
Create Date: 2019-04-16 11:36:59.855204
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('reco_type', sa.String(length=20), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('recommend_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['blogtype_id'], ['blogtype.id'], ),
    sa.ForeignKeyConstraint(['category_id'], ['category.id'], ),
    sa.ForeignKeyConstraint(['recommend_id'], ['recommend.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.ID'], ),
    sa.PrimaryKeyConstraint('id')
    )
